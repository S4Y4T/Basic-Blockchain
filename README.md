...
**Objective**: The objective of this mini-project is to  is to get acquainted with the fundamental concepts of blockchain technology and provide practical experience in implementing a basic blockchain system using the Merkle tree.

<h2>
  1. Define Blockchain Structure
</h2>
...
<h2>
  2. Initialize Blockchain with a genesis block  
</h2>
...
```
<h2>
  3. Implementation of block addition with proper linking 
</h2>
...
```
<h2>
  4. Transaction handling within blocks 
</h2>
...
<h2>
  7. Console Interface Integration
</h2>
